...
#include "libavutil/avutil_timestamp.h"

#include "libavcodec/avcodec_bytestream.h"
#include "libavcodec/avcodec_internal.h"
#include "libavcodec/avcodec_raw.h"

//#include "audiointerleave.h"
#include "avformat.h"
#include "avformat_avio_internal.h"
//#include "avformat_id3v2.h"
#include "avformat_internal.h"
#include "avformat_metadata.h"
#if CONFIG_NETWORK
#include "avformat_network.h"
#endif
//#include "avformat_riff.h"
...
static int parse_packet(AVFormatContext * s, AVPacket * pkt, int stream_index)
{
    ...
    while (size > 0 || (pkt == &flush_pkt && got_output))
    {
        ...
        /*Start of luny on 2014-9-25 14:7 1.0*/
        out_pkt.codec_type = st->codec->codec_type;
        out_pkt.codec_id = st->codec->codec_id;
        out_pkt.key_frame = st->parser->key_frame;
        /*End of luny on 2014-9-25 14:7 1.0*/

...
#define FFMPEG_CONFIGURATION "--disable-doc --disable-asm --disable-everything --enable-debug --enable-muxer=rtsp --enable-muxer=h264 --enable-demuxer=h264 --enable-parser=h264 --enable-demuxer=rtsp --enable-encoder=aac --enable-encoder=mpeg4 --enable-protocol=file --disable-ffprobe --disable-ffmpeg --disable-ffplay"

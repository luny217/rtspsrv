...
//#include "libavutil/avutil_cpu.h"
...
#include "libavutil/avutil_pixfmt.h"
...
#if FF_API_CODEC_ID
#include "avcodec_old_codec_ids.h"
#endif
};
 ...
 * av_free_packet().
 */
#define ENABLE_NVR_TIMESTAMPING
#include <time.h>

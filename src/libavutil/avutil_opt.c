...
#include "avutil_opt.h"
#include "avutil_eval.h"
#include "avutil_dict.h"
#include "avutil_log.h"
#include "avutil_parseutils.h"
#include "avutil_pixdesc.h"
#include "avutil_mathematics.h"
#include "avutil_samplefmt.h"
...
{
    return set_string_fmt(obj, o, val, dst, AV_PIX_FMT_NB, av_get_pix_fmt, "pixel format");
}
#endif
...
{
    return set_string_fmt(obj, o, val, dst, AV_SAMPLE_FMT_NB, av_get_sample_fmt, "sample format");
}
#endif
